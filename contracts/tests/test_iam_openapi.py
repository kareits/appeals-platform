"""Contract test for the IAM-service OpenAPI document.
...
SPEC_PATH = Path(__file__).resolve().parents[1] / "openapi" / "iam-service.v1.yaml"
...
def test_expected_operations_present() -> None:
    """The spec declares the TASK_01D operations."""
    spec = _load_spec()
    operation_ids = {
